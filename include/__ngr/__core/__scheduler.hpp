...
//     -> __file_descriptor {
//     int __rc =
//         static_cast<int>(::syscall(__NR_io_uring_setup, __entries,
//         &__params));
...
//     return __kernel_timespec{.tv_sec = __sec.count(), .tv_nsec =
//     __dur.count()};
// }
...
//     return reinterpret_cast<_Ty>(static_cast<std::byte *>(__base) +
//     __offset);
// }
...
//     case _Sg::_S_schedule: static_cast<__timer_task *>(__op)->_M_stop();
//     break; case _Sg::_S_stop:     {
...
//         const __memory_mapped_region &__sq, const __memory_mapped_region
//         &__sqe, const ::io_uring_params &__p) : __head_{*__at_offset_as<__u32
//         *>(__sq.__data_, __p.sq_off.head)},
...
//           __mask_{*__at_offset_as<__u32 *>(__sq.__data_,
//           __p.sq_off.ring_mask)},
...
//           __cqe_{
//               __at_offset_as<::io_uring_cqe *>(__cqe.__data_,
//               __p.cq_off.cqes)},
//           __mask_{
...
//         __sqe_region_ = __map_region(__ringfd_.__fd_, IORING_OFF_SQES,
//         __n_sqe); if (((__params_.features & IORING_FEAT_SINGLE_MMAP) == 0U))
//         {
//             __cq_region_ =
...
//             __u64 __buf = 1;
//             int   __rc  = (int)::write(__eventfd_.__fd_, &__buf,
//             sizeof(__buf));
...
//                 __manual_stop(
//                     static_cast<__generic_timer_task
//                     *>(__tmp._M_pop_front()));
//             }
//         } else {
//             while (!__tmp._M_empty()) {
...
//             int               __rc __attribute__((__uninitialized__)); //
//             NOLINT
//             __kernel_timespec __ts __attribute__((__uninitialized__)); //
//             NOLINT bool              __timeout = false;

//             if (__timer_task *__top = __heap_.__root_) {
//                 __ts = __duration_to_timespec(
//                     __top->__key_.__deadline_ -
//                     __timer_task::__clock::now());
//                 __timeout = true;
//             }
//             if (__timeout) {
